...
// `isDatabaseConfigured` lets build-time code paths (generateStaticParams)
// no-op gracefully in DB-less environments (fresh clones, CI).
export { getDb, isDatabaseConfigured, prisma, prisma as db } from './client';
