...
// Port 3000 matches the web app's dev server (Next's default, NEXTAUTH_URL).
// These loopback hosts only work on a SIMULATOR/EMULATOR — on a physical device
// set EXPO_PUBLIC_API_URL to the host machine's LAN IP (e.g.
